...
namespace Benchmark {
    ...
    public class JsonBenchmark {
        readonly JsonOptions camelcased = new JsonOptions {
        ...
        public void WriteObjectStream() {
            using MemoryStream ms=new MemoryStream();
            NightlyCode.Json.Json.Write(new TestData {
                Guid = Guid.Empty,
                Decimal = 0.33m,
                Long = 4,
                String = "Hello there",
